...
%
  ...
  \curlyframe[.9\columnwidth]{
		...
		\begin{minipage}{1\textwidth}
	      In recognition for you valued dedication and outstanding \mbox{performance} I herby award:
		\end{minipage}
		} %======employee of the 
	      \smallskip
	      \vfill
		...
		\textcolor{red!30!black!90}
		{\textit{Employee of the}}
		{\bfseries \color{FireBrick}{\typeAward}}
		\end{minipage}
		}
		\smallskip
		\vfill
		 {\begin{minipage}{.55\textwidth}
		to:\uuline{\emph{\large\sffamily\color{name}{{{\color{DarkRed}\fontfamily{frc}\selectfont{\bfseries \honoree}}}}}}
		\end{minipage}
		}
		\vspace{.5in}
		%}
	...
	%   \vspace{5in}
		...
		\graphicspath{{sigy}}
		\sigskip \signature{\includegraphics[trim=2cm 1cm 0 -1cm]{\sigy}}{\phantom{p}{\color{DarkGreen}{\bfseries \creator}}\phantom{g} \\ Creator}
		\end{minipage}
		\hfill
